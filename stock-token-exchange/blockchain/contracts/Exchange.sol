...
contract Exchange is Ownable {
    ...
    /**
     * @dev 自動檢查並處理 Cartesi 計算結果
     * @param _cartesiId Cartesi 計算請求 ID
     * @return processed 是否成功處理了結果
     */
    ...
    /**
     * @dev 批量檢查多個 Cartesi 請求的結果
     * @param _cartesiIds 要檢查的 Cartesi ID 陣列
     * @return processedCount 成功處理的請求數量
     */
    ...
    /**
     * @dev 輪詢所有活躍的 Cartesi 請求並自動處理完成的結果
     * @return processedCount 成功處理的請求數量
     */
