...
async function main() {
  try {
    ...
    console.log('Token wallet balance:', ethers.formatEther(tokenBalance));
    ...
    try {
      if (exchangeFunctions.includes('getUserEthBalance')) {
        ...
        console.log('Exchange ETH balance (getUserEthBalance):', ethers.formatEther(exchangeEthBalance));
      } else {
    ...
    try {
      if (exchangeFunctions.includes('getUserTokenBalance')) {
        ...
        console.log('Exchange token balance (getUserTokenBalance):', ethers.formatEther(exchangeTokenBalance));
      } else {
    ...
    if (exchangeFunctions.includes('ethDeposits')) {
      try {
        ...
        console.log('Raw ethDeposits storage:', ethers.formatEther(ethDeposits));
      } catch (error) {
